...
const ArticleCard = (currArticle) => {
      ...
      return (
            <>
                  <div className="bg-white flex flex-col border border-separate rounded-lg w-fit items-center shadow-lg md:w-[40vw] lg:w-[20vw]">
                        ...
                        <Link href={`/articles/${currArticle.id}?title=${currArticle.title}`} >
